...
const buckets = [
  { pct: "30–35%", label: "Physical & Digital Gold", sub: "Bullion + VGOLD tokens in vaulted custody", color: GOLD },
    ...
    <SectionWrapper id="portfolio" style={{ padding: isMobile ? "60px 20px" : "80px 40px", background: "#fff" }}>
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          <span style={{ fontSize: 10, color: GOLD, fontWeight: 700, letterSpacing: 2 }}>VGOLD SP PORTFOLIO</span>
        ...
        {/* Bar */}
        <div style={{ background: "#FAFAF5", border: `1px solid ${BORDER}`, borderRadius: 12, padding: 24, marginBottom: 28 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "repeat(5, 1fr)", gap: 14 }}>
          {buckets.map((b, i) => (
            <div key={i} style={{ borderLeft: `3px solid ${b.color}`, background: "#FAFAF5", borderRadius: 8, padding: "16px 14px" }}>
