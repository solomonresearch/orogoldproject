...
const cards = [
  ...
  { icon: Lock, title: "Segregated Portfolio", desc: "VGOLD SP operates as a Segregated Portfolio, providing legal ring-fencing of assets. Each investor's position is isolated from other portfolio risks." },
...
export default function CustodySecurity() {
  ...
  return (
    <SectionWrapper id="custody" style={{ padding: isMobile ? "60px 20px" : "80px 40px", background: "#FAFAF5" }}>
