...
const faqs = [
  { q: "What is OROx1?", a: "OROx1 is a gold-backed digital asset where 1 token represents 1 troy ounce of gold, backed by 10,000,000 oz of JORC/43-101 certified reserves in Tier 1 jurisdictions. Tokens can be held for gold-price exposure or staked into the OROx1 Segregated Portfolio for yield of up to 15% per annum." },
