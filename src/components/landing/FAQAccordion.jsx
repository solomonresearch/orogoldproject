...
const faqs = [
  ...
  { q: "What are the tranches?", a: "OROx1 is issued in 5 tranches (T1–T5) with different minimum investments ($10K–$1M) and investor eligibility tiers. Each tranche targets a specific investor profile, from strategic anchors to qualified public participants." },
